...
export const emptyConsultant = {
  name: "نام مشاور",
  role: "عنوان یا حوزه مسئولیت",
  ...
  consultants: z
    .array(
      z.object({
        ...
        role: text(140),
        bio: text(600),
        specialties: z.array(text(80)).min(1, "حداقل یک تخصص وارد کنید.").max(6),
        imageUrl: optionalUrl,
        linkedinUrl: optionalUrl,
        visible: z.boolean().default(true),
      }),
    )
    .min(1, "حداقل یک مشاور لازم است.")
    .max(12, "حداکثر ۱۲ مشاور قابل ثبت است.")
